...
- Filterlogik: `src/lib/filters.js` (Fragen) · `src/data/lernobjekte.js` (einheitlich Fragen+Lernzettel + Filter) · Auswertung: `src/lib/statistik.js`
